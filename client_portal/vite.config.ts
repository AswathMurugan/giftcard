...
export default defineConfig({
   ...
   */
  cacheDir: path.resolve(__dirname, ".vite-vista"),
  ...
  server: {
    // Vista runs alongside Forge (5173) and Relay (5175). Fixed rather than
    // left to Vite's auto-increment so the three apps always land on the same
    // ports and a bookmarked tab keeps working.
    port: 5176,
    strictPort: true,
