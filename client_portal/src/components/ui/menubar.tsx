...
function Menubar({
  ...
  return (
    <MenubarPrimitive.Root
      data-slot="menubar"
      className={cn(
        "flex h-8 items-center gap-0.5 rounded-lg border p-[0.1875rem]",
        className
      )}
      {...props}
    />
...
function MenubarTrigger({
  ...
  return (
    <MenubarPrimitive.Trigger
      ...
      className={cn(
        "flex items-center rounded-sm px-1.5 py-[0.125rem] text-sm font-normal outline-hidden select-none hover:bg-muted aria-expanded:bg-muted",
        className
      )}
      {...props}
    />
...
function MenubarLabel({
  ...
  return (
    <MenubarPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        "px-1.5 py-1 text-sm font-normal data-inset:pl-7",
        className
      )}
      {...props}
    />
